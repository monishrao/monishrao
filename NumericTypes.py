...
class Qualean:
    ...
    def __init__(self,user_input: Decimal):
        ...
        self.value = self.dec_convert(self.input)

    def __repr__(self):
        return 'Quanlean: {0}'.format(self.input)

    def dec_convert(self, input):
        return self.input * Decimal.from_float(random.uniform(-1, 1)).__round__(10)
